            ...
            <div class="divide-white divide-y-2 text-white border-t-2 border-b-2 border-solid border-white">
              ...
              v-for="item in betsMatch.list" :key="item.id">
                <li class="col-span-8 md:col-span-5">
                  <p class=" text-center md:text-left h-8">{{item.match.esd}}</p>
                  <p class=" text-center md:text-left h-8">{{item.match.t1}} <b class="px-2 text-yellow-300">VS</b> {{item.match.t2}}</p>
                </li>
