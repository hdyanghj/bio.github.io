<template>
  <section class="soccer_bg pt-4 pb-10 min-h-full lg:flex lg:justify-center lg:items-center lg:pt-20">
      <div class="w-11/12 lg:max-w-7xl mx-auto flex flex-col lg:flex-row lg:space-x-4">
        ...
        <div class="w-full lg:w-7/12 soccer border-4 border-solid border-white px-4 py-8 lg:p-8 rounded-lg relative">
          ...
          <div class=" w-56 z-30 cursor-pointer absolute right-4 top-4 text-sm rounded bg-gray-50 flex bg-gradient-to-b from-blue-400 bg-blue-800 text-white py-2 px-4">
          ...
          v-if="games && soccerList.list.length>0">
            <div class="flex justify-center items-center flex-col space-y-6 h-full">
              ...
              <button class="w-11/12 py-2 px-4 text-center bg-white flex justify-center rounded focus:outline-none overflow-hidden"
              ...
              <button class="w-11/12 py-3 px-4 text-xl text-center bg-gradient-to-b text-white from-yellow-400 bg-yellow-600 rounded-full focus:outline-none"
