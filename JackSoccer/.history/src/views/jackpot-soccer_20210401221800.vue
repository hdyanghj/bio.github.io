  ...
  <section class="soccer_bg pt-4 pb-10 min-h-full lg:flex lg:justify-center lg:items-center lg:pt-20">
      <div class="w-11/12 lg:max-w-7xl mx-auto flex flex-col lg:flex-row lg:space-x-4">
        ...
        <div class="w-full lg:w-7/12 soccer border-4 border-solid border-white px-4 py-8 lg:p-8 rounded-lg relative">
          ...
          <div class=" w-64 rounded bg-gray-50 flex bg-gradient-to-b from-blue-400 bg-blue-800 text-white py-2 px-4">
            <svg class="w-6 mr-4" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
